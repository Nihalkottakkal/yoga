...
export default function Vision() {
  return (
    <section className="py-4 pb-24 bg-sand relative overflow-hidden">
      <Reveal className="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        <div className="glass-panel p-8 md:p-12 rounded-3xl relative">
          ...
          <p className="text-xl md:text-2xl text-earth font-serif italic leading-relaxed">
            Our vision is to preserve the authentic essence of traditional yoga
            while making its profound benefits accessible to the modern world.
            We aim to foster a community where holistic well-being is not just a
            practice, but a continuous journey of self-evolvement.
          </p>
        </div>
      </Reveal>
    </section>
